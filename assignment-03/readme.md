13. Browsers work by sending HTTP signals to the servers. It then retrieves whatever web page is trying to be reached and the page is displayed in the browser.  
